...
(async () => {
  ...
  const email = `teste.r18.${Date.now()}@example.com`;
  ...
  const ids = ["vigilancia-epidemiologica","principios-sus","indicadores-saude","rastreio-cancer","saude-mental-ab","etica-medica-bioetica","estudos-epidemiologicos","testes-diagnosticos-acuracia","bioestatistica-testes-hipotese","aps-esf","mbe-revisao-sistematica-metanalise","medicina-legal-fundamentos","saude-trabalhador-doencas-ocupacionais","gestao-em-saude","medicina-familia-comunidade","calendario-vacinal-adulto-idoso","incongruencia-genero"];
  for (const id of ids) {
